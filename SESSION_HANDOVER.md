...
> **Running:** dashboard via launchd (`com.ramistp.dashboard`, KeepAlive) on **http://127.0.0.1:8787** (`serve 30min`), **restarted 2026-07-02 08:47 IST on the `dcea92f` binary** (PID 35906), on **2026-07-01 intraday data + edge maps (30min: 1629 edges)**. (2026-07-02 session data lands after the 16:00 refresh; edge maps are July-1 until then.)
